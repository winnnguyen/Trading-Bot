...
API_KEY = 'PK242L5U0LPVD1MW5UPO'
API_SECRET = 'hS4pbR2eb89w8NT0r6rKXRMQjFEH77QBP0pmgdUF'
...
class MLTrader(Strategy):
    def initialize(self, symbol:str='SPY', cash_at_risk:float=.5):
        ...
        self.api = REST(base_url=API_URL, key_id=API_KEY, secret_key=API_SECRET)
    ...
    def on_trading_iteration(self):
        ...
        probability, sentiment = self.get_sentient()
